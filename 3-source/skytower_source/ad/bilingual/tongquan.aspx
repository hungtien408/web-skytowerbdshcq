...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                                                ...
                                                <table class="search">
                                                    <tr>
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <span class="required">(Kích thước 600px x 423px)</span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtDienTichToanKhu" runat="server" Width="500px" Text='<%# Bind("DienTichToanKhu") %>'
                                                                EmptyMessage="Diện tích toàn khu...">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtSoCanHo" runat="server" Width="500px" Text='<%# Bind("SoCanHo") %>'
                                                                EmptyMessage="Số căn hộ...">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtGia" runat="server" Width="500px" Text='<%# Bind("Gia") %>'
                                                                EmptyMessage="Giá...">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtDatCho" runat="server" Width="500px" Text='<%# Bind("DatCho") %>'
                                                                EmptyMessage="Khách hàng đặt chỗ...">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtDienTichXayDung" runat="server" Width="500px" Text='<%# Bind("DienTichXayDung") %>'
                                                                EmptyMessage="Diện tích sàn xây dựng...">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtKhongGianSinhHoat" runat="server" Width="500px" Text='<%# Bind("KhongGianSinhHoat") %>'
                                                                EmptyMessage="Không gian sinh hoạt...">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr class="invisible">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProductSelectAll"
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="Priority" Type="String" />
            <asp:Parameter Name="IsAvailable" Type="String" />
            <asp:Parameter Name="DienTichToanKhu" Type="String" />
            <asp:Parameter Name="SoCanHo" Type="String" />
            <asp:Parameter Name="SoTang" Type="String" />
            <asp:Parameter Name="Gia" Type="String" />
            <asp:Parameter Name="DatCho" Type="String" />
            ...
            <asp:Parameter Name="KhongGianSinhHoat" Type="String" />
        </InsertParameters>
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchPriceTo" Name="PriceTo" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter DefaultValue="3" ControlID="ddlSearchCategory" Name="CategoryID" PropertyName="SelectedValue"
                Type="String" />
