<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="danhmuctienich.aspx.cs" Inherits="ad_single_productcategory" %>
                    ...
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">
                                Thông Tin Danh Mục Tiện Ích</h3>
                            <table class="search">
                                <tr class="invisible">
                                ...
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtProductCategoryName" runat="server" Text='<%# Bind("ProductCategoryName") %>'
