...
public partial class ad_single_product : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            string DienTichToanKhu = ((RadTextBox)row.FindControl("txtDienTichToanKhu")).Text.Trim();
            string SoCanHo = ((RadTextBox)row.FindControl("txtSoCanHo")).Text.Trim();
            string SoTang = ((RadTextBox)row.FindControl("txtSoTang")).Text.Trim();
            string Gia = ((RadTextBox)row.FindControl("txtGia")).Text.Trim();
            string DatCho = ((RadTextBox)row.FindControl("txtDatCho")).Text.Trim();
            ...
            string KhongGianSinhHoat = ((RadTextBox)row.FindControl("txtKhongGianSinhHoat")).Text.Trim();
