    ...
    public class Product
    {
        ...
        )
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Priority", string.IsNullOrEmpty(Priority) ? dbNULL : (object)Priority);
                cmd.Parameters.AddWithValue("@IsAvailable", string.IsNullOrEmpty(IsAvailable) ? dbNULL : (object)IsAvailable);
                cmd.Parameters.AddWithValue("@DienTichToanKhu", string.IsNullOrEmpty(DienTichToanKhu) ? dbNULL : (object)DienTichToanKhu);
                cmd.Parameters.AddWithValue("@SoCanHo", string.IsNullOrEmpty(SoCanHo) ? dbNULL : (object)SoCanHo);
                cmd.Parameters.AddWithValue("@SoTang", string.IsNullOrEmpty(SoTang) ? dbNULL : (object)SoTang);
                cmd.Parameters.AddWithValue("@Gia", string.IsNullOrEmpty(Gia) ? dbNULL : (object)Gia);
                cmd.Parameters.AddWithValue("@DatCho", string.IsNullOrEmpty(DatCho) ? dbNULL : (object)DatCho);
                ...
                cmd.Parameters.AddWithValue("@KhongGianSinhHoat", string.IsNullOrEmpty(KhongGianSinhHoat) ? dbNULL : (object)KhongGianSinhHoat);
